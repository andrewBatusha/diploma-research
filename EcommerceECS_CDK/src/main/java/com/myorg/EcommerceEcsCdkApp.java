...
public class EcommerceEcsCdkApp {
    public static void main(final String[] args) {
        ...
        Environment environment = Environment.builder()
                .account("975050214510")
                .region("us-east-1")
                .build();

        Map<String, String> infraTags = new HashMap<>();
        infraTags.put("team", "Batuiev");
        ...
        productsServiceTags.put("team", "Batuiev");
        ...
        auditServiceTags.put("team", "Batuiev");
        ...
        auditServiceTags.put("team", "Batuiev");
        auditServiceTags.put("cost", "InvoicesService");
